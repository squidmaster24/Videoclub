        ...
        <div id="show-film" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.film}" method="DELETE">
                <fieldset class="buttons">
                    <g:if test="${this.film.availability}">
                        <g:link class="book" controller="movieBooking" action="create" params="[filmId: this.film.id]">Reservar</g:link>
                    </g:if>
                    <g:else>
                        %{--<input type="submit" name="unbook" class="unbook" value="Cancelar reserva2" id="unbook">--}%
                        <g:link class="unbook" controller="movieBooking" action="unbook" params="[filmId: this.film.id]">Cancelar Reserva</g:link>
                    </g:else>
