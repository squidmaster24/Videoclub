...
<html>
    ...
    <body>
        ...
        <div id="show-director" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.director}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.director}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
